...
public class CanalClient {
    ...
    public CanalClient(String zkServers, String servers, String topic, Integer partition, String groupId){
        connector = new KafkaCanalConnector(servers, topic, partition, groupId, null, false);
    }

    public static void main(String[] args) {
        try {
            final CanalClient kafkaCanalClientExample = new CanalClient(AbstractKafkaTest.zkServers,
